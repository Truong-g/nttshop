...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (isset($categoryFilterParam)) {
            $products->where("categories.slug", "=", $categoryFilterParam);
        }


        $brandFilterParam = $request->input("brand");
        if (isset($brandFilterParam)) {
            $products->where("brands.slug", "=", $brandFilterParam);
        }


        $colorFilterParam = $request->input("color");
        if (isset($colorFilterParam)) {
            $products->where("product_colors.value", "=", $colorFilterParam);
        }


        $sizeFilterParam = $request->input("size");
        if (isset($sizeFilterParam)) {
            $products->where("product_sizes.size", "=", $sizeFilterParam);
        }


        $starFilterParam = $request->input("star");
        if (isset($starFilterParam)) {
            $products->where("product_stars.stars", "=", $starFilterParam);
        }
        ...
        $priceFilterParam = $request->input("price");
        if (isset($priceFilterParam)) {
            $arrayPrice = explode("to", $priceFilterParam);
            $products->whereBetWeen("products.pricesale", $arrayPrice);
        }
        ...
        $products->groupBy("products.id", "product_stars.id");
